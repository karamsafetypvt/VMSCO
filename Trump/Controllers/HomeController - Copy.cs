...
namespace Trump.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Login(string ID, string Password)
        {
            ...
            else if (login.Master_Requestor.Any(m => m.Email_ID == ID && m.TrumpPassword == Password) == true)//changed dec23
            {
        ...
        public ActionResult EditPage(tblAppoinment ap, int hiddenGPID, FormCollection fc)
        {
            if (Session["NAME"] != null)
            {
                ...
                string link = "http://122.185.30.43:8016";
               // string AppointmntMsg = msgtemp.Template.Replace("@p1", CompanyMaster).Replace("@p2", tb.V_DateFrom.Value.ToString("dd/MMM/yyyy")).Replace("@p3", tb.A_Time + ".").Replace("@p4", tb.GPID).Replace("@p5", tb.GPID).Replace("@p6", link);//working
                ...
                string url = @"http://122.185.30.43:8016/Home/SG/" + tb.GPID;
        ...
        public FileResult ImageDownload(string GatePassID)
        {
            ...
            else
            {
                ...
                //layer.WhatsAppAttachment(vData.V_Phone.ToString(), data.Valid_at, mastercompany, "http://122.185.30.43:8016/Content/images/StringImage/" + GatePassID + ".jpg");
            }
        ...
        //        string urls = "http://122.185.30.43:8016/Home/SG/" + lastData.GPID;


        //        string urlimage = "http://122.185.30.43:8016/Content/images/StringImage/" + lastData.GPID + ".jpg";
...

        {
            if (Session["NAME"] != null)
            {
                ...
                //    string SecurityAppointmnt = "Dear " + dd.V_Name + " Welcome to one of the leading PPE manufacturing unit " + mastercompany + " Please follow our guidelines board and click the below link to ACCEPT Safety Guidelines and generate ePass " + "http://122.185.30.43:8016/Home/SG/" + lastData.GPID + " KARAM";
        ...
        //        //  stringBuilder.Append("Dear " + strname + ", <br/><br/>Your courier is pending to acknowledge. Kindly acknowledge it. <br/>Click link to acknowledge:<a href='http://172.20.1.106:8016/'>Click</a><br/>");
        ...
        //        //stringBuilder.Append("Click link to acknowledge:< a href = 'http://172.20.1.106:8016/' > Click </ a >< br />");
        //        stringBuilder.Append(" <br/><a href='http://172.20.1.106:8016/'>Click</a><br/>");
        ...
        public string SendMailEmployeeCourierconfirm(int CouriarId)
        {
            ...
            try
            {
                ...
                StringBuilder stringBuilder = new StringBuilder();
                string strdate = DateTime.Now.ToString();
                stringBuilder.Append("Dear " + strname + ", <br/><br/>Please confirm your courier acceptance for Docket Number: " + dispatchid + "<br/>");
